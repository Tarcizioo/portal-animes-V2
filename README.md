...
1. Create a [Vercel](https://vercel.com) account and connect it to your GitHub.
2. Import the `portal-animes-V2` repository. Vercel auto-detects Vite.
3. In **Project Settings → Environment Variables**, add all your Firebase keys from the `.env` file.
4. Click **Deploy**.

### GitHub Pages

Deployment to GitHub Pages is configured out of the box:
